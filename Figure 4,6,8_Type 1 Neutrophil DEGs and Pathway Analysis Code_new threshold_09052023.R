...
Neu1_N0vT3 <- FindMarkers(object = lung, 
                          ...
                          min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vT3, "Neu1_N0vT3_newthrs.csv")
...
Neu1_N0vT12 <- FindMarkers(object = lung, 
                           ...
                           ident.2 = WhichCells(lung, cells = rownames(lung@meta.data[lung@meta.data$orig.ident=="N0",]), idents = "Type 1 Neutrophils"), 
                           min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vT12, "Neu1_N0vT12_newthrs.csv")
...
Neu1_N0vT28 <- FindMarkers(object = lung, 
                           ...
                           ident.2 = WhichCells(lung, cells = rownames(lung@meta.data[lung@meta.data$orig.ident=="N0",]), idents = "Type 1 Neutrophils"), 
                           min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vT28, "Neu1_N0vT28_newthrs.csv")
...
Neu1_N0vS3 <- FindMarkers(object = lung, 
                           ...
                           ident.2 = WhichCells(lung, cells = rownames(lung@meta.data[lung@meta.data$orig.ident=="N0",]), idents = "Type 1 Neutrophils"), 
                           min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vS3, "Neu1_N0vS3_newthrs.csv")
...
Neu1_N0vS28 <- FindMarkers(object = lung, 
                           ...
                           ident.2 = WhichCells(lung, cells = rownames(lung@meta.data[lung@meta.data$orig.ident=="N0",]), idents = "Type 1 Neutrophils"), 
                           min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vS28, "Neu1_N0vS28_newthrs.csv")
...
Neu1_N0vS12 <- FindMarkers(object = lung, 
                           ...
                           ident.2 = WhichCells(lung, cells = rownames(lung@meta.data[lung@meta.data$orig.ident=="N0",]), idents = "Type 1 Neutrophils"), 
                           min.pct = 0.1, logfc.threshold = 0.25, assay = "RNA", only.pos = FALSE)
write.csv(Neu1_N0vS12, "Neu1_N0vS12_newthrs.csv")
#Note
#DEGs were determined to be from these genes lists after 
#converting the p_val_adj to the negative log 10 p value adjusted
#any neg log10 p val adj greater than 2 and a p adj higher than 0.05 was considered a sig DEG
...
#terms limited to between 5 and 300 genes
