#Now that have all clusters identified, running Cell Chat to identify key cell groups
#tutorial: https://htmlpreview.github.io/?https://github.com/sqjin/CellChat/blob/master/tutorial/Comparison_analysis_of_multiple_datasets.html
...
# when ready to create chord diagrams, load already combined cell chat object
cellchat <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat.rds")
cellchat
object.list <- list(N0 = cellchat_N0, S12 = cellchat_S12, T12 = cellchat_T12, S3 = cellchat_S3,
                    T3 = cellchat_T3, S28 = cellchat_S28,T28 = cellchat_T28)
cellchat_N0 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_N0.rds")
cellchat_S12 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_S12.rds")
cellchat_S3 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_S3.rds")
cellchat_S28 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_S28.rds")
cellchat_T12 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_T12.rds")
cellchat_T3 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_T3.rds")
cellchat_T28 <- readRDS("C:/Users/kathe/Dropbox/KAM R Code/SCT_12122022/CellChat/cellchat_T28.rds")


##Signalling from Type 1 Neutrophils (group #3) to all other cell types (1,2,4:20)
par(mfrow = c(1, 1), xpd=TRUE)
for (i in 1:length(object.list)) {
  netVisual_chord_gene(object.list[[i]], sources.use = 3, targets.use = c(1,2,4:20), lab.cex = 0.6,
                       legend.pos.x = 10, legend.pos.y = 10,small.gap = 8,annotationTrackHeight = c(0.04),
                       title.name = paste0("Signaling from Type 1 Neutrophils - ", names(object.list)[i]))
}
